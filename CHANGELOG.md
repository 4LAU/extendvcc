...
- **Recurring cards** — support for `MONTHLY`, `WEEKLY`, and other recurrence periods with configurable terminators.
...
- **CLI** — full lifecycle commands: `login`, `accounts`, `cards`, `create`, `get`, `update`, `cancel`, `close`, `reveal`, `reconcile`.
